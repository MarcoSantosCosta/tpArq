...
/**
 * Classe que contem um Map com chave|valor onde valor é um short que representa
 * a chave
 *
 * @author Diego
 */
public class Dicionario {
     ...
     * @param arqReg Nome do arquivo que contem o par chave|valor par os
     * Registradores
    ...
    /**
     * Método que abre um arquivo e coloca o par chave|valor que está no arquivo
     * no Map
     *
    ...
    /**
     * Método que inicializa o dicionario lendo dos arquivos os pares
     * chaves|valor. Arquivos: op, func, type
     */
...
//        System.err.println("FUNCAO Chave: "+key+" Codigo: "+dicionarioDeFuncs.get(key));
        return dicionarioDeFuncs.get(key);
        
    }

    /**
     * Método que retorna um valor a partir da chave passada, representando o
     * Func
     *
    ...
    public short getOp(String key) {
         //System.err.println("OPERACAO Chave: "+key+" Codigo: "+dicionarioDeOps.get(key));
