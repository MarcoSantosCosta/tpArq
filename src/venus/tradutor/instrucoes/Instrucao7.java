 ...
 * @author neche
 */
public class Instrucao7 implements Instrucao{
    private short func;
    private short rc;
    private short op;
    private short ra;
    ...
    public Instrucao7(short func,short rc,short op,short ra,short rb){
        this.func = func;
        this.rc = rc;
        this.op = op;
        this.ra = ra;
    ...
    public String getBin(){
        int conta = ((func << 14) | (rc << 11) | (op << 6) | (ra << 3) | (rb&0b111));     
